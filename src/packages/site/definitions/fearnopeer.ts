...
export const siteMetadata: ISiteMetadata = {
  ...
  search: {
    ...
    selectors: {
      ...
      category: { selector: ["td.torrent-search--list__format div.torrent-search--list__category"], attr: "alt"},
      ...
      tags: [
        ...
        {
          name: "可退款",
          selector: "i[title*='Refundable'], span[title*='Refundable']",
          color: "gray",
        },
        {
          name: "内部组发布",
          selector: "i[title*='Internal Release'], span[title*='Internal Release']",
          color: "purple",
        },
        {
          name: "个人发布",
          selector: "i[title*='Personal Release'], span[title*='Personal Release']",
          color: "purple",
        },
        {
          name: "高速",
          selector: "i[title*='High Speeds'], span[title*='High Speeds']",
          color: "red",
        },
      ],
    },
